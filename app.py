...
# base_path="C:/Users/patri/OneDrive/Desktop/sqlalchemy/Resources/hawaii.sqlite" - used for local testing
...
def welcome():
    return (
        ...
        f"/api/v1.0/tobs<br/>"
        f"/api/v1.0/start (replace start with YYYY-MM-DD)<br/>"
        f"/api/v1.0/start/end (replace start/end YYYY-MM-DD/YYYY-MM-DD)"
...
# RE: DATES ONLY WORK PRIOR TO 2017-08-23, IT WILL SHOW NULL OTHERWISE!!!
